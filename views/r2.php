<div class="resultsContainer">
  ...
  <span class="justify-content-center text-center resultTitle">
          ...
          Votre situation peut relever d’un COVID 19. Vos symptômes indiquent qu'un <u>avis médical est nécessaire</u>.

      </span>

            <div class="resultAlert">

                <p class="resultSubtitle result-pad font-weight-bold d-flex align-items-center">
                    Programmez une visite avec votre médecin traitant habituel.
                </p>
                <p class="resultText">
                    Ne vous déplacez pas au cabinet, appelez pour demander conseil avant votre venue !
                    <br>

                </p>

                <p class="resultSubtitle result-pad font-weight-bold d-flex align-items-center">
                    Si vous n'arrivez pas à joindre un médecin rapidement
                </p>
                <p class="resultText">
                    Vos symptômes décrivent un état de santé dégradé. Si vous n'arrivez pas à joindre
                    votre médecin traitant rapidement, un appel au SAMU (téléphone : 14)
                    peut s'avérer nécessaire. Appelez le 14 dès l'apparition ou le maintient
            ...
            <div class="moreQuestions">
                <p class="resultSubtitle font-weight-bold align-items-center">
                    <img class="resultImgWarning" src="public/img/icon/alert-circle.svg" alt="">
            ...
            <div class="moreQuestions">
                ...
                <p class="resultText">
                    Appelez le <a href="tel:3030">3030</a>
                </p>
                <p class="resultText">
                    et suivez l'actualité sur <a href="http://covid19.sante.gov.dz/" target="_blank" class="underline">http://covid19.sante.gov.dz/
                    </a>
                </p>
            </div>
        ...
        <div class="result-foot-numbers-container">
            <div class="result-foot-numbers-top-container">
                <img class="headset-img" src="public/img/icon/icon-headset.svg" alt="">
                ...
                <a href="tel:3030" class="button button-white">
                    3030 <span class="option">(appel gratuit)</span>
                </a>
            ...
            <div class="result-foot-numbers-bottom-container">
                <div class="result-foot-numbers-bottom-link-container">
                    ...
                    <a href="http://covid19.sante.gov.dz/" target="_blank">covid19.sante.gov.dz</a>
                </div>
                <div class="result-foot-numbers-bottom-link-container">
                    <p>Vous avez des questions d'ordre général :</p>
                    <a href="tel:3030">3030 - (appel gratuit)</a>
                </div>
            </div>
        ...
        <div class="resultFoot d-flex flex-column">
            ...
            <a href="test_init.php" class="btn btn-primary btn-lg buttonRetake">Recommencez
                le test</a>
        </div>
