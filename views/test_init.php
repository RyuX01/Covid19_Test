    <div class="preambule">
        <div class="preambule-content">
            <h2 class="preambule-header">Préambule</h2>
            <p>
        ...
        <form method="post" action="test.php" class="preambule-button">
            <input type="hidden" name="current_step" value="step_1" />
            ...
            <button class="button button-primary" >
                ...
                <img class="arrow-right" src="public/img/icon/icon-arrow-right.svg" alt="" />
