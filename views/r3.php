    ...
    <div class="results">
        <div class="d-flex flex-column">
            ...
            <span class="justify-content-center text-center resultTitle">
                ...
                Votre situation peut relever d’un COVID 19. Vos symptômes nécessitent <u>une prise en charge rapide</u>.
            ...
            <div class="resultAlert">
                ...
                <p class="resultSubtitle font-weight-bold d-flex align-items-center">
                    <img class="resultImgWarning" alt="" src="public/img/icon/alert-triangle.svg">Appelez le <a class="resultNumber" href="tel:14">14</a>
                </p>
                <p class="resultText">
                    Les SAMU-centres 14 disposent des dernières procédures en vigueur dans votre zone géographique.
